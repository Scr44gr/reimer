...
| Standard library plan | `alloc`, `c`, `collections`, `fs`, `io`, `math`, `string`, `target`, `thread`, `job`, and `tensor` | Broader formatting/Unicode APIs |
