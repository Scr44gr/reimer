...
| Standard library plan | `alloc`, `collections`, `io`, `string`, `target`, `thread`, `job`, and `tensor` | Planned `fs`, `c`, and `math` modules plus broader formatting/Unicode APIs |
